            ...
            <div className="pt-20">
                <main className="mx-auto max-w-5xl px-4 py-12 space-y-12">
                    <section className="space-y-4">
                        ...
                        <h1 className="text-4xl md:text-6xl font-black tracking-tight text-white lg:leading-tight">
                            Multi-Chain DeFi <br />
                            <span className="bg-clip-text text-transparent bg-gradient-to-r from-accent-neon to-emerald-400">Backtesting Simulator</span>
                        </h1>
                        <p className="text-xl text-slate-400 max-w-2xl leading-relaxed">
                            Analyze historical performance across ecosystem parachains with high-precision XCM modeling and slippage estimation.
                        </p>
                    </section>
